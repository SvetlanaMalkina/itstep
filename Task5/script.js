...
console.log(f)
/*
1. Выражение -"" является NaN с отрицательным значением.
2. Делим 10 на NaN с отрицательным значением.
3. Выводим в консоль.
4. Получаем на выходе -Infinity, так как деление числа на не число с отрицательным значением
даёт отрицательную бесконечность.
 */
let g=10/+"2,5";
console.log(g)
/*
